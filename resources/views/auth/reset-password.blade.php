<x-guest-layout>
    <div>
        <h2 class="text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-white">Atur Ulang Password</h2>
        <p class="mt-2 text-sm leading-6 text-gray-500 dark:text-gray-400">
            Buat password baru Anda di bawah ini.
        </p>
    </div>
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-2 relative">
                    ...
                    <x-text-input id="email" class="block w-full ps-10" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
                </div>
